        ...
        <div className="row">
          <div className="col-lg-8 mt-4 mt-lg-0">
            <div className="row">
              ...
              <div className="col-lg-6 mt-4" data-scroll-reveal="enter bottom move 50px over 0.7s after 0.2s">
                <div className="room-box background-grey">
              ...
              <div className="col-lg-6 mt-4" data-scroll-reveal="enter bottom move 50px over 0.7s after 0.4s">
                <div className="room-box background-grey">
                ...
                <div className="col-12 pt-5">
                  ...
                  <div className="selecteurPrix">
                    <div className="range-slider">
                      <input className="input-range" type="range" defaultValue={100} min={1} max={500} />
