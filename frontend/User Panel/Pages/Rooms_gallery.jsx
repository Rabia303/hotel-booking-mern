          ...
          <div className="col-lg-8 mt-4 mt-lg-0">
            <div className="section">
              <div className="customNavigation rooms-sinc-1-2">
                <a className="prev-rooms-sync-1" />
                <a className="next-rooms-sync-1" />
              </div>		
              <div id="rooms-sync1" className="owl-carousel">
                <div className="item">
                  <img src="./src/pages/assets/img/gallery/2.jpg" alt />						
                </div>
                <div className="item">	
                  <img src="./src/assets/img/gallery/3.jpg" alt />					
                </div>
                <div className="item">	
                  <img src="./src/assets/img/gallery/4.jpg" alt />					
                </div>
                <div className="item">	
                  <img src="./src/assets/img/gallery/5.jpg" alt />					
                </div>
                <div className="item">	
                  <img src="./src/assets/img/gallery/6.jpg" alt />					
                </div>
                <div className="item">	
                  <img src="./src/assets/img/gallery/7.jpg" alt />					
                </div>
                <div className="item">	
                  <img src="./src/assets/img/gallery/8.jpg" alt />					
                </div>
                <div className="item">	
                  <img src="./src/assets/img/gallery/9.jpg" alt />					
                </div>
              </div>
            </div>
            <div className="section">
          ...
          <div className="room-box background-grey">
            ...
            <div className="room-box-in">
              ...
              <div className="room-icons mt-4 pt-4">
                ...
                <a href="./src/./src/rooms-gallery.html">full info</a>
              </div>
            </div>
          </div>
        </div>
